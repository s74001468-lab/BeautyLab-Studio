...
def get_main_keyboard():
    return ReplyKeyboardMarkup(keyboard=[
        ...
        [KeyboardButton(text="Прайс 💇‍♀️"), KeyboardButton(text="Частые вопросы ❓")],
...
# Кнопка Прайс
@dp.message(F.text == "Прайс 💇‍♀️")
async def show_price(message: Message):
    text = (
        "💸 **Прайс-лист BeautyLab Studio**\n\n"
        "✂️ **Стрижки**\n"
        "• Женская стрижка — 1500 ₽ (60 мин)\n"
        "• Мужская стрижка — 1000 ₽ (30 мин)\n\n"
        "🎨 **Окрашивание**\n"
        "• Окрашивание (в один тон) — от 3500 ₽ (90 мин)\n"
        "• Сложное окрашивание — от 5000 ₽\n\n"
        "💅 **Ногтевой сервис**\n"
        "• Маникюр с покрытием — 1800 ₽ (60 мин)\n"
        "• Педикюр с покрытием — 2200 ₽ (60 мин)\n"
    )
...
async def show_faq(message: Message):
    text = (
        "❓ **Частые вопросы (FAQ)**\n\n"
        "**1. Где вы находитесь?**\n"
        "Мы находимся в самом центре Краснодара.\n\n"
        "**2. Можно ли перенести или отменить запись?**\n"
        "Да, вы можете отменить запись через бота (кнопка «Мои записи»), если до визита осталось более 24 часов. Если менее — напишите администратору.\n\n"
        "**3. Есть ли у вас парковка?**\n"
        "Да, для наших клиентов доступна бесплатная закрытая парковка. Просто предупредите нас перед въездом.\n\n"
        "**4. Какие способы оплаты вы принимаете?**\n"
        "Мы принимаем наличные, банковские карты и переводы по СБП.\n\n"
        "**5. Работают ли мастера в выходные?**\n"
        "Да, мы работаем ежедневно с 10:00 до 20:00 без перерывов и выходных!"
    )
    await message.answer(text, parse_mode="Markdown")
